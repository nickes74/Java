...
// --------------------------------------------------------------------------
    public void lire(Versement versement) throws SQLException, IOException, ClassNotFoundException
    {
        int rowCount;
...
// --------------------------------------------------------------------------
    public int creer(Versement versement) throws SQLException, IOException, ClassNotFoundException
    {
        int rowCount;
        String insert;
...
// --------------------------------------------------------------------------
    public int modifier(Versement versement) throws SQLException, IOException, ClassNotFoundException
    {
        int rowCount;
        String update;
...
// --------------------------------------------------------------------------
    public int detruire(Versement versement) throws SQLException, IOException, ClassNotFoundException
    {
        int rowCount;
        String delete;
...
// --------------------------------------------------------------------------
    public Vector<Versement> lireListe(Contact contact) throws SQLException, IOException, ClassNotFoundException
    {
...
// --------------------------------------------------------------------------
    public Vector<Versement> lireListe() throws SQLException, IOException, ClassNotFoundException
    {
        Vector<Versement> listeVersements;
        Versement versement;
