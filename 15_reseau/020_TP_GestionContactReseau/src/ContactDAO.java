...
// --------------------------------------------------------------------------
    public void lire(Contact contact) throws  IOException, ClassNotFoundException, SQLException
    {
        int rowCount;
...
// --------------------------------------------------------------------------
    public int creer(Contact contact) throws  IOException, ClassNotFoundException, SQLException
    {
        int rowCount;
        String insert;
...
// --------------------------------------------------------------------------
    public int modifier(Contact contact) throws  IOException, ClassNotFoundException, SQLException
    {
        int rowCount;
        String update;
...
// --------------------------------------------------------------------------
    public int detruire(Contact contact) throws  IOException, ClassNotFoundException, SQLException
    {
        int rowCount;
        String delete;
...
// --------------------------------------------------------------------------
    public Contact lireContact(Versement versement) throws  IOException, ClassNotFoundException, SQLException
    {
...
// --------------------------------------------------------------------------
    public Vector<Contact> lireListe(Secteur secteur) throws  IOException, ClassNotFoundException, SQLException
    {
...
// Liste des contacts
// --------------------------------------------------------------------------
    public Vector<Contact> lireListe() throws  IOException, ClassNotFoundException, SQLException
    {
        Vector<Contact> listeContacts;
        Contact contact;
